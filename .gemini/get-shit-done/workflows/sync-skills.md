...
INSTALL_JS_GLOBAL="D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
