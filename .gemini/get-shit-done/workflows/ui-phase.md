...
```markdown
Read D:/Documentsss/lyrics-teleprompter/.gemini/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/Documentsss/lyrics-teleprompter/.gemini/agents/gsd-ui-checker.md for instructions.
