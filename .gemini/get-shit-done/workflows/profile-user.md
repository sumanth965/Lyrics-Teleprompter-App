...
Key references:
- @D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/references/ui-brand.md (display patterns)
- @D:/Documentsss/lyrics-teleprompter/.gemini/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/USER-PROFILE.md" "D:/Documentsss/lyrics-teleprompter/.gemini/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/references/user-profiling.md`
...
Reference: @D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to D:/Documentsss/lyrics-teleprompter/.gemini/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/Documentsss/lyrics-teleprompter/.gemini/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to D:/Documentsss/lyrics-teleprompter/.gemini/CLAUDE.md"
...
```bash
BACKUP_PATH="D:/Documentsss/lyrics-teleprompter/.gemini/USER-PROFILE.backup.md"
```
...
Your profile:    D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/Documentsss/lyrics-teleprompter/.gemini/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        D:/Documentsss/lyrics-teleprompter/.gemini/CLAUDE.md
```
