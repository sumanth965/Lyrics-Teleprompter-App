...
```bash
INIT=$(node "D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/templates/spec.md.
