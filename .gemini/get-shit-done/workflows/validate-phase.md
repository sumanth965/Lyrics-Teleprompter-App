...
```
Task(
  prompt="Read D:/Documentsss/lyrics-teleprompter/.gemini/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/templates/VALIDATION.md`
