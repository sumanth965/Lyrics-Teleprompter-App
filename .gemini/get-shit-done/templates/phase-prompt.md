...
<!-- For checkpoint task examples and patterns, see @D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/references/checkpoints.md -->
...
See `D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/workflows/verify-phase.md` for verification logic.
