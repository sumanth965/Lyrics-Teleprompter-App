...
- Usage: Reference from command with `@D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/Documentsss/lyrics-teleprompter/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/Documentsss/lyrics-teleprompter/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
