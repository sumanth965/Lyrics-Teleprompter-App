...
<reference>
@D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/Documentsss/lyrics-teleprompter/.gemini/get-shit-done/references/user-profiling.md` to load:
